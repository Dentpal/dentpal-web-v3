              ...
              {previewDetail?.product && (previewDetail.product.warrantyType || previewDetail.product.dangerousGoods) && (
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border border-amber-100">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">Insurance &amp; Evaluation</div>
                      <div className="text-sm font-medium text-gray-900">
                        {previewDetail.product.insuranceAndEvaluation ? (
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-800">Yes</span>
                        ) : (
                          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800">No</span>
                        )}
                      </div>
